...
class WalkerEnv(MujocoEnv, utils.EzPickle):
    def __init__(self, cfg, agent):
        ...
        if self.cfg.xml_name == "default":
            self.model_xml_file = os.path.join(cfg.project_path, "assets", "mujoco_envs", "walker.xml")
        else:
    ...
    def step(self, a):
        ...
        # execution stage
            ...
            # print("control_nsteps, posafter, height, ang:", self.control_nsteps, posafter, height, ang)
