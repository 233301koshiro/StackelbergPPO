...
| リンク比 0.55 / 0.5 / 0.5 | 腕÷絵の最大寸法 **0.705** | XML 実測 総リーチ **0.789 m** → ❌ **1.02 倍に伸ばせ**（⚠️ 9-30 で上乗せ撤去。旧値 1.12） |
...
|---|---|---|---|
| **B1** | 0.705 | **0.789 m** | ❌ **1.02 倍**に伸ばせ（旧値 1.12） |
...
| B1 | ✅ マゼンタ3個・比を保存（0.705→0.700） | 1回 | **3/3 自動**（⚠️ Bug 30 の 3D 化が必要だった） | **0.7891 m** | **❌ 届かない → 1.02 倍**（旧値 1.12） | ✅ 公称=実効 |
...
⚠️ **上の倍率は 10 % 上乗せ込みの旧値。9-30 で撤去したので現在は 平面 1.02 / 縦型 1.18 倍。**
